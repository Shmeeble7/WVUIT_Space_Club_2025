//This is the sketch for the "Scribe" board included in the WVUIT Space Club 2026 project
//It is the reciever antenna board 
...
void processPacket(char* packet)
{
  ...
  if (separator == NULL)
  {
    //Commenting these out so the program doesn't crash when running headless
