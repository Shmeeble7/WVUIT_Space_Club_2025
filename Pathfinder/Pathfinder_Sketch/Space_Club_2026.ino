...
// https://github.com/adafruit/Adafruit_9DOF IMU code example
// https://github.com/adafruit/Adafruit_MMC56x3 Magnetometer code example
// 
...
void setup()
{
  ...
  // I2C mode
  if (!mag.begin(MMC56X3_DEFAULT_ADDRESS, &Wire2))
  {  
    // There was a problem detecting the MMC5603 ... check your connections
    //Serial.println("Ooops, no MMC5603 detected ... Check your wiring!");
    //Serial.print("Problem 2");
    while (!mag.begin(MMC56X3_DEFAULT_ADDRESS, &Wire2))
    {
      digitalWrite(lightpin, HIGH);
      delay(1000);
      digitalWrite(lightpin, LOW);
...
void magnetometerTest()
{
  ...
  if(SensorData)
  {
    ...
    SensorData.print("uT "); SensorData.print("  ");
    SensorData.print("Temp: "); SensorData.print(temp_c); SensorData.print(" *C ");
    SensorData.print("--");
